...
def process_video(frames):
    # Selecione os primeiros 8 frames para garantir a compatibilidade com o modelo
    selected_frames = frames[:8]
    inputs = processor(text=["apple", "hand", "cow"], videos=[selected_frames], return_tensors="pt", padding=True, truncation=True)
