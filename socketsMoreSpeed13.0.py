...
def capture_frames(interval=1, target_frames=8):
    ...
    while len(frames) < target_frames:
        ...
        if current_time - start_time >= interval / target_frames:
...
def start_server():
    ...
    try:
        while True:
            # Captura frames continuamente a cada 1 segundo
            frames = capture_frames(interval=1)
